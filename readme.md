...
An end-to-end **Clinical Decision Support System (CDSS)** that combines **Machine Learning** and **Generative AI** to assess diabetes risk, analyze patient symptoms, generate explainable clinical insights, and produce professional **PDF health reports**.
...
- Absence of personalized intervention plans
- No unified clinical reporting system
...
- Generates clinician-grade and patient-friendly explanations
- Recommends personalized intervention plans
...
- Confidence estimation & uncertainty handling
...
- Clinician-focused medical reports
...
User Input
   ↓
Symptom Analyzer (GenAI)
   ↓
ML Risk Predictor
   ↓
Counterfactual Analysis
   ↓
Clinical Insight Generator (GenAI)
   ↓
